 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var l,o;class s extends n$3{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0;}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Dt=w(i,this.renderRoot,this.renderOptions);}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!0);}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Dt)||void 0===t||t.setConnected(!1);}render(){return b}}s.finalized=!0,s._$litElement$=!0,null===(l=globalThis.litElementHydrateSupport)||void 0===l||l.call(globalThis,{LitElement:s});const n$1=globalThis.litElementPolyfillSupport;null==n$1||n$1({LitElement:s});(null!==(o=globalThis.litElementVersions)&&void 0!==o?o:globalThis.litElementVersions=[]).push("3.0.1");
...
class TouchSwipeCard extends s {
    constructor() {
        super(...arguments);
        ...
        this.pageWidth = Math.max(document.documentElement.scrollWidth, document.documentElement.offsetWidth, document.documentElement.clientWidth);
    }
    connectedCallback() {
        super.connectedCallback();
        const items = [...this.children].filter((el) => el.getAttribute('slot') === 'item');
        if (items.length != 1) {
            throw new Error(`touch-swipe-card Must have one "item" slot. Found ${items.length}`);
        }
        this.card = [...this.children].find((el) => el.getAttribute('slot') === 'item');
        const options = [...this.children].filter((el) => el.getAttribute('slot') === 'options');
        if (options.length != 1) {
            throw new Error(`touch-swipe-card Must have 1 "options" slot. Found ${items.length}`);
        }
        const optionValues = [...options[0].children]
            .filter((el) => el.type === 'radio')
            .map((r) => r.value);
        if (optionValues.length != 2) {
            throw new Error(`touch-swipe-card "options" slot must have 2 radio buttons with "value" atrtibutes. Found ${optionValues.length}`);
        }
    ...
    _moveCard(x, y) {
        ...
        const activeCard = this.shadowRoot.querySelector('.active');
...
__decorate([
    e({ type: Function })
], TouchSwipeCard.prototype, "dropLeft", void 0);
__decorate([
    e({ type: Function })
], TouchSwipeCard.prototype, "dropRight", void 0);
__decorate([
    e({ type: Element })
], TouchSwipeCard.prototype, "card", void 0);
__decorate([
    e({ type: Array })
], TouchSwipeCard.prototype, "optionValues", void 0);
__decorate([
    e()
], TouchSwipeCard.prototype, "dragActive", void 0);
__decorate([
    e()
], TouchSwipeCard.prototype, "leftDropActive", void 0);
__decorate([
    e()
], TouchSwipeCard.prototype, "rightDropActive", void 0);
__decorate([
    e()
], TouchSwipeCard.prototype, "activeCardPosition", void 0);
__decorate([
    e({ type: Number })
], TouchSwipeCard.prototype, "pageWidth", void 0);
TouchSwipeCard = __decorate([
    n('touch-swipe-card')
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
], TouchSwipeCard);
